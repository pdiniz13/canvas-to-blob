# Meteor Canvas to Blob

# Note 
This package is a wrapper around blueimp's JavaScript-Canvas-to-Blob. The following documentation has been adapted 
from his readme.
...
## Usage
Add this package.
meteor add pdiniz13:canvas-to-blob
...
However, Canvas to Blob is a very suitable complement to the [JavaScript Load Image](https://github
.com/blueimp/JavaScript-Load-Image) function. As well as any blob storage upload package.
...
## License
The Meteor Canvas to Blob script is released under the [MIT license](http://www.opensource.org/licenses/MIT).
